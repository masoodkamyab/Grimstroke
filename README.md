...
- 🎯 Entry points to execute your program using `python -m <grimstroke>` or `$ grimstroke` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/masoodkamyab/Grimstroke/branch/main/graph/badge.svg?token=Grimstroke_token_here)](https://codecov.io/gh/masoodkamyab/Grimstroke)
[![CI](https://github.com/masoodkamyab/Grimstroke/actions/workflows/main.yml/badge.svg)](https://github.com/masoodkamyab/Grimstroke/actions/workflows/main.yml)

Awesome grimstroke created by masoodkamyab

## Install

from source
```bash
git clone https://github.com/masoodkamyab/Grimstroke grimstroke
cd grimstroke
make install
```
...
```bash
pip install grimstroke
```

## Executing

```bash
$ grimstroke run --port 8080
```

or

```bash
python -m grimstroke run --port 8080
```

or

```bash
$ uvicorn grimstroke:app
```
...
```bash
❯ grimstroke --help
Usage: grimstroke [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ grimstroke create-user --help
Usage: grimstroke create-user [OPTIONS] USERNAME PASSWORD
...
```bash
grimstroke create-user admin admin --superuser
```
...
Run with `grimstroke run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `grimstroke create-user`.
...
-----------------------------------------------------
grimstroke/__init__.py              4      0   100%
grimstroke/app.py                  16      1    94%
grimstroke/cli.py                  21      0   100%
grimstroke/config.py                5      0   100%
grimstroke/db.py                   10      0   100%
grimstroke/models/__init__.py       0      0   100%
grimstroke/models/content.py       47      1    98%
grimstroke/routes/__init__.py      11      0   100%
grimstroke/routes/content.py       52     25    52%
grimstroke/routes/security.py      15      1    93%
grimstroke/routes/user.py          52     26    50%
grimstroke/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in grimstroke/default.toml.
